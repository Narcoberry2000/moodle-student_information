...
$PAGE->set_url('/local/student_information/studentdedication.php', $params);
$PAGE->set_pagelayout('course');
//$PAGE->add_body_class('limitedwidth');
$PAGE->set_pagetype('my-index');
$PAGE->blocks->add_region('content');
$PAGE->set_subpage($currentpage->id  . "_3");
...
if(!$DB->record_exists('block_instances', array('parentcontextid' =>  $context->id, 'subpagepattern' =>  $currentpage->id  . "_3", 'blockname' => "user_dedication")))
    {
    $record = new stdClass(); 
    $record->blockname = 'user_dedication'; // Nombre del bloque a introducir (Y encargado de mostrar el bloque especifico)
    ...
    $record->subpagepattern = $currentpage->id  . "_3"; //Identificador de la pagina en la que se debe mostrar el bloque
